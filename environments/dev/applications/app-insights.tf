resource "azurerm_application_insights" "app_insights" {
  name                = "ai-hsk-um-${var.environment}"
...
#   name                  = "mpls-hsk-um-${var.environment}"
...
resource "azurerm_log_analytics_workspace" "dev" {
  name                = "log-analytics-hsk-uma-${var.environment}"
  location            = module.dev-rg.location
  resource_group_name = module.dev-rg.name
  sku                 = "PerGB2018"
...
#   resource_group_name = data.azurerm_resource_group.dev_rg.name #The name of the Azure Monitor Private Link Scope rg. Changing this forces a new resource to be created.
#   scope_name          = "mpls-hsk-um-dev"
...
#   resource_group_name = data.azurerm_resource_group.dev_rg.name #The name of the Azure Monitor Private Link Scope. Changing this forces a new resource to be created.
#   scope_name          = "mpls-hsk-um-dev"
